-- jedlá
INSERT INTO `meals`
    (`id`, `name`, `price`, `amount`, `meal_type`, `last_edit`)
VALUES
...
-- ľudia
INSERT INTO `people`
    (`id`, `card_id`, `full_name`, `email`, `password`, `credit`, `admin`, `last_edit`)
VALUES
    (1, '3940957484', 'Tester Admin', 'admin@edofood.com', 'e7d012abd5716788da1868943d9488c3df6bc56c43fb5cd12e24de5e4410f66f', 150.00, 'Y', '2022-09-23 20:15:45'),
    (2, '0703755014', 'Tester Testovač', 'tester@edofood.com', '78005eb4fff88b1dcc9b0020aadaabe719b85f22aa47e5ce16d73ee20d188365', 5.00, 'N', '2022-09-23 20:15:52');
...
-- objednávky
INSERT INTO `orders`
    (`id`, `menu_item`, `person`, `timestamp`, `valid`)
VALUES
    (1, 1, 1, '2022-10-23 19:51:26', 'Y'),
    (2, 3, 1, '2022-10-23 19:51:29', 'Y');